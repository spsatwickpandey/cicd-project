...
describe('API Performance Tests', () => {
  ...
  beforeAll(async () => {
    ...
    // Seed test data
    await testUtils.database.seedUsers(testData.users);
    await testUtils.database.seedProducts(testData.products);
  });

  afterAll(async () => {
    // Cleanup test data
    await testUtils.database.clearUsers();
    await testUtils.database.clearProducts();
  });
  ...
  describe('Memory Usage Monitoring', () => {
    ...
    it('should handle large response payloads efficiently', async () => {
      ...
      await testUtils.database.seedProducts(largeProductList);
